...
def run_scenario(
    ...
    """Model a simple revenue/expense scenario without mutating source data."""
    ...
    return {
        "baseline": {
            ...
            "profit_margin_pct": round(baseline_margin, 2),
        },
        "scenario": {
            "revenue": round(scenario_revenue, 2),
            "expenses": round(scenario_expenses, 2),
            "profit": round(scenario_profit, 2),
            "profit_margin_pct": round(scenario_margin, 2),
        },
        "impact": {
            "revenue_change": round(scenario_revenue - revenue, 2),
            "expense_change": round(scenario_expenses - expenses, 2),
            "profit_change": round(scenario_profit - baseline_profit, 2),
            "margin_change_pct_points": round(scenario_margin - baseline_margin, 2),
        },
        "assumption": "This is a sensitivity scenario. It is not a forecast or causal estimate.",
    }
