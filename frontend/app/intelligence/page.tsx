...
export default function IntelligencePage() {
  return <main style={{ maxWidth: 1050, margin: "0 auto", padding: "48px 24px" }}>
    ...
    <section style={{ margin: "18px 0 16px" }}><p style={eyebrowStyle}>Business Intelligence</p><h1 style={{ fontSize: 48, margin: "8px 0" }}>From data to business understanding.</h1><p style={{ color: "#667085", fontSize: 17, maxWidth: 720, lineHeight: 1.6 }}>Move through the four questions of business analysis: what happened, why, what next, and what should we do.</p></section>
    <div style={{ display: "grid", gap: 14 }}><section style={cardStyle}><div style={eyebrowStyle}>Analysis lens</div><h2 style={{ margin: "8px 0 14px" }}>Choose how to think about the data</h2><AnalysisMode /></section><IntelligenceSummary rows={demoRows} /><BusinessCharts rows={demoRows} /><SuggestedQuestions /><InsightActions /></div>
  </main>;
}
