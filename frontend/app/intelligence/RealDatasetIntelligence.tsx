  ...
  useEffect(() => {
    ...
    async function runAnalysis() {
      try {
        ...
        const [analysisResponse, anomalyResponse, driverResponse] = await Promise.all([
